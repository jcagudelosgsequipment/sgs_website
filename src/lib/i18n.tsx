...
export const dict = {
  ...
  "quote.pdf.promptTitle": {
    es: "¿Descargar PDF de la cotización?",
    en: "Download quote PDF?",
  },
  "quote.pdf.promptDesc": {
    es: "Tu solicitud fue enviada. ¿Deseas descargar un PDF con tus datos y los equipos seleccionados?",
    en: "Your request was sent. Would you like to download a PDF with your details and selected equipment?",
  },
  "quote.pdf.yes": { es: "Sí, descargar", en: "Yes, download" },
  "quote.pdf.no": { es: "No, gracias", en: "No, thanks" },
  "quote.pdf.downloading": { es: "Generando PDF…", en: "Generating PDF…" },
  "quote.pdf.title": { es: "Solicitud de Cotización", en: "Quote Request" },
  "quote.pdf.customerSection": { es: "Datos del cliente", en: "Customer details" },
  "quote.pdf.equipmentSection": { es: "Equipos solicitados", en: "Requested equipment" },
  "quote.pdf.manufacturer": { es: "Fabricante", en: "Manufacturer" },
  "quote.pdf.model": { es: "Modelo", en: "Model" },
  "quote.pdf.category": { es: "Categoría", en: "Category" },
  "quote.pdf.capacity": { es: "Capacidad", en: "Capacity" },
  "quote.pdf.year": { es: "Año", en: "Year" },
  "quote.pdf.fuel": { es: "Combustible", en: "Fuel" },
  "quote.pdf.workOrder": { es: "Work Order", en: "Work Order" },
  "quote.pdf.generatedAt": { es: "Generado", en: "Generated" },
  "quote.pdf.footer": {
    es: "Documento de solicitud — SGS Equipment. No constituye una oferta formal.",
    en: "Request document — SGS Equipment. This is not a formal offer.",
  },
  "quote.pdf.noImage": { es: "Sin imagen", en: "No image" },
  ...
  "equipos.empty": { es: "No se encontraron equipos con estos filtros.", en: "No equipment found with these filters." },
  "equipos.categories": { es: "Categorías", en: "Categories" },
  "equipos.all": { es: "Todos", en: "All" },
  "equipos.filters": { es: "Filtros", en: "Filters" },
  "equipos.filter.search": { es: "Buscar", en: "Search" },
  "equipos.filter.searchPlaceholder": { es: "Modelo, fabricante, WO…", en: "Model, manufacturer, WO…" },
  "equipos.filter.fuelType": { es: "Tipo de combustible", en: "Fuel type" },
  "equipos.filter.capacity": { es: "Capacidad", en: "Capacity" },
  "equipos.filter.manufacturer": { es: "Fabricante", en: "Manufacturer" },
  "equipos.filter.year": { es: "Año", en: "Year" },
  "equipos.filter.yearFrom": { es: "Desde", en: "From" },
  "equipos.filter.yearTo": { es: "Hasta", en: "To" },
  "equipos.filter.clear": { es: "Limpiar", en: "Clear" },
